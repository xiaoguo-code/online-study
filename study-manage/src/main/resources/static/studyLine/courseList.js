...
function deletes(studyLineIds){
    layer.confirm('确定删除？', {
        ...
        $.ajax({
            async: true,
            type: 'POST',  //提交方法是GET
            url: '/admin/studyLine/delete', //请求的路径
            data: {
                studyLineIds: studyLineIds,
            },
            headers: {
                contentType: "application/json",
            },
...
//查询学习路线
function getStudyLineList(pageIndex, pageSize) {
    let keyword = $("#searchCondition").val();
    ...
    $.ajax({
        async: true,
        type: 'GET',  //提交方法是GET
        url: '/admin/studyLine/listStudyLine', //请求的路径
        data: {
            async:true,
            pageIndex:pageIndex,
            pageSize:pageSize,
