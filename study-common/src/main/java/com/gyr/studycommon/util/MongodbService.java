...
public class MongodbService {
    ...
    public void init() {
        mongodbService = this;
        mongodbService.mongoTemplate = this.mongoTemplate;
    }
    ...
    public static Object findSortById(Class<?> entiy, String collName, Sort.Direction direction) {
        ...
        return mongodbService.mongoTemplate.find(query, entiy, collName);
    }
    ...
    public static Object findDesignField(List<String> fields, Map<String, Object> map, Class<?> clazz, String collName, boolean returnId) {
        ...
        return mongodbService.mongoTemplate.find(query, clazz, collName);
    }
    ...
    public static Object findAll(Class<?> entiy, String collName) {
        return mongodbService.mongoTemplate.findAll(entiy, collName);
    }
    ...
    public static void createIndex(String collName, String indexName, Map<String, Sort.Direction> map) {
        ...
        mongodbService.mongoTemplate.indexOps(collName).ensureIndex(index);
    }
    ...
    public static Object getIndexInfo(String collName) {
        return mongodbService.mongoTemplate.indexOps(collName).getIndexInfo();
    }
    ...
    public static void removeIndexByName(String collName, String indexName) {
        mongodbService.mongoTemplate.indexOps(collName).dropIndex(indexName);
    }
    ...
    public static void removeIndexByName(String collName) {
        mongodbService.mongoTemplate.indexOps(collName).dropAllIndexes();
    }
    ...
    public static void removeAllByParam(String key, String value, String collName) {
        ...
        mongodbService.mongoTemplate.remove(query, collName);
    }
    ...
    public static List<? extends Object> findSortByParam(Object obj, String collName, Map<String, Object> map, String sortField, Sort.Direction direction) {
        ...
        return mongodbService.mongoTemplate.find(query, obj.getClass(), collName);
    }
    ...
    public static long count(String collName, String key, String value) {
        ...
        return mongodbService.mongoTemplate.count(query, "goods");
    }
    ...
    public static Long countRangeCondition(Class<?> clazz, String collName, Criteria rangeCriteria, Map<String, Object> map) {
        ...
        return mongodbService.mongoTemplate.count(query, clazz, collName);
    }
    ...
    public static Object findSortFirst(Class<?> clazz, Map<String, Object> map, String collName, String field, Sort.Direction direction) {
        ...
        return mongodbService.mongoTemplate.findOne(query, clazz, collName);
    }
    ...
    public static void updateMulti(String accordingKey, Object accordingValue, Map<String, Object> map,
        ...
        if (type == 1) {
            mongodbService.mongoTemplate.updateFirst(query, update, collName);
        } else {
            mongodbService.mongoTemplate.updateMulti(query, update, collName);
        }
    }
    ...
    public static Object findSum(Class<?> clazz, Map<String, Object> map, String collName, String sumField, Criteria rangeCriteria) {
        ...
        return mongodbService.mongoTemplate.aggregate(Aggregation.newAggregation(match, count), collName, clazz).getMappedResults();
    }
    ...
    public static PageModel findSortPageCondition(Class<?> clazz, String collName, Map<String, Object> map,
        ...
        if (criteria == null) {
            count = mongodbService.mongoTemplate.count(new Query(), clazz, collName);
        } else {
            count = mongodbService.mongoTemplate.count(new Query(criteria), clazz, collName);
        }
        ...
        List<?> list = mongodbService.mongoTemplate.find(query, clazz, collName);
    ...
    private static void saveData(String collName, Object entiy) {
        if (StringUtils.isEmpty(collName)) {
            mongodbService.mongoTemplate.save(entiy);
        } else {
            mongodbService.mongoTemplate.save(entiy, collName);
        }
    }
