package com.gyr.studybusiness.authentication.interceptor;
...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        Object user = session.getAttribute(WebConst.LOGIN_SESSION_USER_KEY);

        if(null == user && uri.startsWith("/business")
                &&!uri.startsWith("/business/main/index")&&!uri.startsWith("/business/main/chooseOneCategory")
                &&!uri.startsWith("/business/register")&&!uri.startsWith("/business/login") && !uri.startsWith("/static/index")
